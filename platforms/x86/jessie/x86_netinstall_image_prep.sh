...
wget https://github.com/samuelrock/AllStar/raw/master/platforms/x86/jessie/x86_netinstall_allstar_asterisk_install.sh -O /srv/x86_netinstall_allstar_asterisk_install.sh

# DL firstboot rc.local patch and put in in /tmp
wget https://github.com/samuelrock/AllStar/raw/master/patches/patch-x86-first-netinstall-rc.local -O /tmp/patch-x86-first-netinstall-rc.local
...
wget https://github.com/samuelrock/AllStar/raw/master/patches/patch-exim4 -O /tmp/patch-exim4
cd /etc/default/
...
wget https://github.com/samuelrock/AllStar/raw/master/patches/patch-interfaces -O /tmp/patch-interfaces
cd /etc/network
